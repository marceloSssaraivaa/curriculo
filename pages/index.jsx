...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Currículo PRO - Crie Currículos Profissionais Gratuitamente</title>
        <meta
          name="Cv Builder"
          content="Crie currículos profissionais gratuitamente no Currículo PRO. Nosso construtor de currículos oferece modelos modernos e personalizáveis para ajudá-lo a se destacar. Faça um currículo de qualidade de forma rápida e fácil."
        />
        <link rel="icon" href="/curriculo.png" />
      </Head>
      <CvContext.Provider
        value={{
          cv,
