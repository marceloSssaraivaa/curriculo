  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <span className="flex-1">Projetos/Publicações</span>
          <motion.div
                ...
                >
                  <div className="bg-gradient-to-tr from-transparent to-gray-100 rounded-xl border px-2 py-1">
                    ...
                    <div className=" items-center mt-4">
                      <label className="text-gray-500">Titulo do Projeto/Publicação</label>
                      <input
                        type="text"
                        className="inputStyle"
                        placeholder="Nome do Projeto/Publicação"
                        value={project.title}
                        onChange={(e) => {
                          const newProject = {
                            ...project,
                    ...
                    <div className=" items-center mt-4">
                      <label className="text-gray-500">Link do Projeto/Publicação</label>
                      <input
                        type="text"
                        className="inputStyle"
                    ...
                    <div className=" items-center mt-4 mb-6">
                      <label className="text-gray-500">Resumo do projeto</label>
                      <textarea
                        type="textarea"
                        rows={3}
