              ...
              {cv.experiences.map((experience, index) => (
                ...
                >
                  <div className="bg-gradient-to-tr from-transparent to-gray-100 rounded-xl border px-2 py-1">
                    ...
                    <div className=" items-center mt-4">
                      <label className="text-gray-500">Resumo</label>
                      <textarea
                        type="textarea"
                        rows={7}
                        placeholder="Breve informação de 3-4 frases sobre o que você faz na empresa."
                        className="inputStyle"
                    ...
                    <div className=" items-center mt-4">
                      ...
                      <input
                        type="text"
                        className="inputStyle"
                        placeholder="O ano que você começou este trabalho?"
                    ...
                    <div className="items-center mt-4 mb-6">
                      ...
                      <input
                        type="text"
                        placeholder="Ano que saiu do emprego?"
                        className="inputStyle"
