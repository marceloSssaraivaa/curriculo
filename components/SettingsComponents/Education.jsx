  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        >
          <span className="flex-1">Formação acadêmica</span>
          <motion.div
                ...
                >
                  <div className="bg-gradient-to-tr from-transparent to-gray-100 rounded-xl border px-2 py-1">
                    ...
                    <div className="items-center mt-4 transition-all ">
                      <label className="text-gray-500">Área de estudo</label>
                      <input
                        type="text"
                    ...
                    <div className=" items-center mt-4">
                      <label className="text-gray-500">Universidade</label>
                      <input
                        type="text"
                        className="inputStyle"
                    ...
                    <div className=" items-center mt-4">
                      ...
                      <input
                        type="text"
                        className="inputStyle"
                        placeholder="O ano que você começou?"
                    ...
                    <div className="items-center mt-4 mb-6">
                      ...
                      <input
                        type="text"
                        placeholder="O ano que você acabou?"
                        className="inputStyle"
